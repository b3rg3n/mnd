...
style button_text is gui_text:
    ...
    yalign 0.5
    font "gesmemories/fnt/mnd_not_survive.otf"
...
screen navigation():
    ...
    vbox:
        ...
        if main_menu:
            ...
            textbutton _("Сойти с ума") action Start()
        ...
        if _in_replay:
            ...
            textbutton _("К началу") action MainMenu()
...
screen about():
    ...
    use game_menu(_("???"), scroll="viewport"):
        ...
        vbox:
            ...
            label "[config.name!t]"
            text _("Версия: Remade")

            ## gui.about обычно установлено в options.rpy.
            if gui.about:
                text "[gui.about!t]\n"

            text _("Автор порта - {a=https://vk.com/b3rg3n}BERGEN{/a}")
            text _("Группа игры в {a=https://vk.com/modernowl}ВК{/a}")
            text _("В ней вы можете посетить обсуждения и найти музыку из игры")
            text _("А так же...")
            text _("Автор не ставит цели присвоить себе чужие труды. Все права на заимствованные аудио и графические материалы принадлежат их правооблодателям.")
...
screen load():
    ...
    use file_slots(_("Вспомнить"))


screen file_slots(title):

    default page_name_value = FilePageNameInputValue(pattern=_("{} страница"), auto=_("Откуда я это помню?"), quick=_("Мимолетные воспоминания"))
